		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav mr-auto">
				    ...
				    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/chat/chatList.do">채팅방 목록</a></li>
					<li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Websocket
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/payment/payment.do">결제하기</a>
                            <sec:authorize access="isAuthenticated() && !hasRole('ADMIN')">
	                            <a class="dropdown-item" href="${pageContext.request.contextPath}/chat/chat.do">관리자와 1:1채팅</a>
                            </sec:authorize>
                        </div>
				    </li>
					<sec:authorize access="hasRole('ADMIN')">
					    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/admin/memberList.do">관리자</a></li>
					    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/admin/chatList.do">회원채팅목록</a></li>
					</sec:authorize>
			    </ul>
